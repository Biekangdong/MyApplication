...
public class PreloadIconDrawable extends Drawable {
    ...
    public void applyPreloaderTheme(Theme t) {
        TypedArray ta = t.obtainStyledAttributes(com.android.launcher3.R.styleable.PreloadIconDrawable);
        mBgDrawable = ta.getDrawable(com.android.launcher3.R.styleable.PreloadIconDrawable_background);
        mBgDrawable.setFilterBitmap(true);
        mPaint.setStrokeWidth(ta.getDimension(com.android.launcher3.R.styleable.PreloadIconDrawable_indicatorSize, 0));
        mRingOutset = ta.getDimensionPixelSize(com.android.launcher3.R.styleable.PreloadIconDrawable_ringOutset, 0);
        ta.recycle();
