...
public class ViewOnDrawExecutor implements Executor, OnDrawListener, Runnable,
    ...
    public void attachTo(DeviceDJMainActivity deviceDJMainActivity) {
        mDeviceDJMainActivity = deviceDJMainActivity;
        mAttachedView = deviceDJMainActivity.getWorkspace();
    ...
    public void markCompleted() {
        ...
        if (mDeviceDJMainActivity != null) {
            mDeviceDJMainActivity.clearPendingExecutor(this);
        }
    }
}
