...
public class FocusLogic {
    ...
    /**
     * Creates a sparse matrix that merges the icon and launcher_hotseat view group using the cell layout.
     * The size of the returning matrix is [icon column count x (icon + launcher_hotseat row count)]
     * in portrait orientation. In landscape, [(icon + launcher_hotseat) column count x (icon row count)]
     */
    // TODO: get rid of the dynamic matrix creation
    public static int[][] createSparseMatrixWithHotseat(
        ...
        // Iterate thru the children of the launcher_hotseat.
