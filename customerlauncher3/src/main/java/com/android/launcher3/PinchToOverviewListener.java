...
public class PinchToOverviewListener extends ScaleGestureDetector.SimpleOnScaleGestureListener
    ...
    public PinchToOverviewListener(DeviceDJMainActivity deviceDJMainActivity) {
        mDeviceDJMainActivity = deviceDJMainActivity;
        mPinchDetector = new ScaleGestureDetector((Context) mDeviceDJMainActivity, this);
    }
    ...
    public boolean onScaleBegin(ScaleGestureDetector detector) {
        if (mDeviceDJMainActivity.mState != DeviceDJMainActivity.State.WORKSPACE || mDeviceDJMainActivity.isOnCustomContent()) {
        ...
        if (mWorkspace == null) {
            mWorkspace = mDeviceDJMainActivity.getWorkspace();
            mThresholdManager = new PinchThresholdManager(mWorkspace);
            mAnimationManager = new PinchAnimationManager(mDeviceDJMainActivity);
        }
        ...
        mPinchStarted = true;
        mWorkspace.onLauncherTransitionPrepare(mDeviceDJMainActivity, false, true);
        return true;
    }
    ...
    public void onScaleEnd(ScaleGestureDetector detector) {
        ...
        if (shouldCancelPinch) {
            ...
            mWorkspace.onLauncherTransitionEnd(mDeviceDJMainActivity, false, true);
        }
        mPinchStarted = false;
    ...
    public boolean onScale(ScaleGestureDetector detector) {
        ...
        if (mDeviceDJMainActivity.getDragController().isDragging()) {
            mDeviceDJMainActivity.getDragController().cancelDrag();
        }
