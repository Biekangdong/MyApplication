 ...
 * - At some threshold 1, launcher_hotseat and QSB fade out (full animation)
 ...
 * - At threshold 2, launcher_hotseat and QSB fade in and scrim fades out
...
public class PinchAnimationManager {
    ...
    public PinchAnimationManager(DeviceDJMainActivity deviceDJMainActivity) {
        mDeviceDJMainActivity = deviceDJMainActivity;
        mWorkspace = deviceDJMainActivity.mWorkspace;
    ...
    public void animateThreshold(float threshold, Workspace.State startState,
      ...
      if (threshold == PinchThresholdManager.THRESHOLD_THREE) {
