...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    public PagedView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.android.launcher3.R.styleable.PagedView, defStyle, 0);
        mPageIndicatorViewId = a.getResourceId(com.android.launcher3.R.styleable.PagedView_pageIndicator, -1);
        a.recycle();
    ...
    protected void onUnhandledTap(MotionEvent ev) {
        DeviceDJMainActivity.getLauncher(getContext()).onClick(this);
    }
    ...
    protected String getCurrentPageDescription() {
        return getContext().getString(com.android.launcher3.R.string.default_scroll_format,
