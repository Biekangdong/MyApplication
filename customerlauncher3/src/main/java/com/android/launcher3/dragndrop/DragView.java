...
public class DragView extends View {
     ...
     * be centered upon.
     * @param deviceDJMainActivity The Launcher instance
     * @param bitmap The view that we're dragging around.  We scale it up when we draw it.
     * @param registrationX The x coordinate of the registration point.
     * @param registrationY The y coordinate of the registration point.
     */
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public DragView(DeviceDJMainActivity deviceDJMainActivity, Bitmap bitmap, int registrationX, int registrationY,
                    final float initialScale, final float finalScaleDps) {
        super(deviceDJMainActivity);
        mDragLayer = deviceDJMainActivity.getDragLayer();
        mDragController = deviceDJMainActivity.getDragController();
