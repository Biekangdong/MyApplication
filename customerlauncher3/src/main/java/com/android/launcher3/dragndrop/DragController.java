...
public class DragController implements DragDriver.EventListener, TouchController {
     ...
     */
    public DragController(DeviceDJMainActivity deviceDJMainActivity) {
        Resources r = deviceDJMainActivity.getResources();
        mDeviceDJMainActivity = deviceDJMainActivity;
    ...
    public void startDrag(View v, Bitmap bmp, DragSource source, ItemInfo dragInfo,
        ...
        mDeviceDJMainActivity.getDragLayer().getLocationInDragLayer(v, loc);
    ...
    public DragView startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        if (mInputMethodManager == null) {
            mInputMethodManager = (InputMethodManager)
                    mDeviceDJMainActivity.getSystemService(Context.INPUT_METHOD_SERVICE);
        }
        ...
        final Resources res = mDeviceDJMainActivity.getResources();
        final float scaleDps = FeatureFlags.LAUNCHER3_LEGACY_WORKSPACE_DND
                ...
                : mIsDragDeferred
                    ...
                    : 0f;
        final DragView dragView = mDragObject.dragView = new DragView(mDeviceDJMainActivity, b, registrationX,
        ...
        if (mOptions.isAccessibleDrag) {
            ...
            mDragDriver = DragDriver.create(mDeviceDJMainActivity, this, mDragObject, mOptions);
        }
        ...
        mDeviceDJMainActivity.getDragLayer().performHapticFeedback(HapticFeedbackConstants.LONG_PRESS);
    ...
    private int[] getClampedDragLayerPos(float x, float y) {
        mDeviceDJMainActivity.getDragLayer().getLocalVisibleRect(mDragLayerRect);
    ...
    private void clearScrollRunnable() {
        ...
        if (mScrollState == SCROLL_WAITING_IN_ZONE) {
            ...
            mDeviceDJMainActivity.getDragLayer().onExitScrollArea();
        }
    }
    ...
    @Thunk void checkScrollState(int x, int y) {
        final int slop = ViewConfiguration.get(mDeviceDJMainActivity).getScaledWindowTouchSlop();
        final int delay = mDistanceSinceScroll < slop ? RESCROLL_DELAY : SCROLL_DELAY;
        final DragLayer dragLayer = mDeviceDJMainActivity.getDragLayer();
    ...
    private PointF isFlingingToDelete(DragSource source) {
        ...
        ViewConfiguration config = ViewConfiguration.get(mDeviceDJMainActivity);
        ...
        } else if (mDeviceDJMainActivity.getDeviceProfile().isVerticalBarLayout() &&
    ...
    private DropTarget findDropTarget(int x, int y, int[] dropCoordinates) {
        ...
        for (int i=count-1; i>=0; i--) {
            ...
            if (r.contains(x, y)) {
                ...
                dropCoordinates[0] = x;
                dropCoordinates[1] = y;
                mDeviceDJMainActivity.getDragLayer().mapCoordInSelfToDescendent((View) target, dropCoordinates);
