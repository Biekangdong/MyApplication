...
public class ExternalDragPreviewProvider extends DragPreviewProvider {
    ...
    public ExternalDragPreviewProvider(DeviceDJMainActivity deviceDJMainActivity, ItemInfo addInfo) {
        super(null);
        mDeviceDJMainActivity = deviceDJMainActivity;
        mAddInfo = addInfo;

        mOutlineSize = mDeviceDJMainActivity.getWorkspace().estimateItemSize(mAddInfo, false);
    }

    public Rect getPreviewBounds() {
        Rect rect = new Rect();
        DeviceProfile dp = mDeviceDJMainActivity.getDeviceProfile();
    ...
    public Bitmap createDragOutline(Canvas canvas) {
        ...
        HolographicOutlineHelper.obtain(mDeviceDJMainActivity).applyExpensiveOutlineWithBlur(b, canvas);
