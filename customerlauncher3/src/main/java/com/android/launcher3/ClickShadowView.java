...
public class ClickShadowView extends View {
    ...
    public ClickShadowView(Context context) {
        ...
        mShadowPadding = getResources().getDimension(com.android.launcher3.R.dimen.blur_size_click_shadow);
        mShadowOffset = getResources().getDimension(com.android.launcher3.R.dimen.click_shadow_high_shift);
    }
    ...
    public void alignWithIconView(BubbleTextView view, ViewGroup viewParent, View clipAgainstView) {
        ...
        int iconHSpace = iconWidth - view.getTextView().getCompoundPaddingRight() - view.getTextView().getCompoundPaddingLeft();
        ...
        setTranslationX(leftShift
                ...
                + view.getTextView().getCompoundPaddingLeft() * view.getScaleX()
