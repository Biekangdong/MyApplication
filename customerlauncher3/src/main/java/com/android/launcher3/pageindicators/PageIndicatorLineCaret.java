...
public class PageIndicatorLineCaret extends PageIndicator {
    ...
    protected void onFinishInflate() {
        ...
        mAllAppsHandle.setOnTouchListener(mDeviceDJMainActivity.getHapticFeedbackTouchListener());
        mAllAppsHandle.setOnClickListener(mDeviceDJMainActivity);
        mAllAppsHandle.setOnLongClickListener(mDeviceDJMainActivity);
        mAllAppsHandle.setOnFocusChangeListener(mDeviceDJMainActivity.mFocusHandler);
    }
