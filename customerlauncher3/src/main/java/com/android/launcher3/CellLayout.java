...
public class CellLayout extends ViewGroup implements BubbleTextView.BubbleTextShadowHandler {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBackground = (TransitionDrawable) res.getDrawable(
                FeatureFlags.LAUNCHER3_LEGACY_WORKSPACE_DND ? com.android.launcher3.R.drawable.bg_screenpanel
                        : com.android.launcher3.R.drawable.bg_celllayout);
        ...
        mDragOutlinePaint.setColor(getResources().getColor(com.android.launcher3.R.color.outline_color));

        // When dragging things around the home screens, we show a green outline of
        // where the item will land. The outlines gradually fade out, leaving a trail
        // behind the drag path.
        // Set up all the animations that are used to implement this fading.
        final int duration = res.getInteger(com.android.launcher3.R.integer.config_dragOutlineFadeTime);
        final float fromAlphaValue = 0;
        final float toAlphaValue = (float)res.getInteger(com.android.launcher3.R.integer.config_dragOutlineMaxAlpha);
    ...
    public void enableAccessibleDrag(boolean enable, int dragType) {
        ...
        if (!enable) {
            ...
            setOnClickListener(mDeviceDJMainActivity);
        } else {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (mDeviceDJMainActivity.mWorkspace.isInOverviewMode()
    ...
    protected void dispatchSaveInstanceState(SparseArray<Parcelable> container) {
        if (mJailContent) {
            ...
            container.put(com.android.launcher3.R.id.cell_layout_jail_id, jail);
        } else {
    ...
    private ParcelableSparseArray getJailedArray(SparseArray<Parcelable> container) {
        final Parcelable parcelable = container.get(com.android.launcher3.R.id.cell_layout_jail_id);
    ...
    private void commitTempPlacement() {
        ...
        long screenId = mDeviceDJMainActivity.getWorkspace().getIdForScreen(this);
        int container = LauncherSettings.CONTAINER_DESKTOP;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            // AllApps button in the launcher_hotseat.
            if (info != null) {
                ...
                if (requiresDbUpdate) {
                    LauncherModel.modifyItemInDatabase(info, container, screenId,
