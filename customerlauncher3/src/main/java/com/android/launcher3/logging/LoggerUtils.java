...
import com.android.launcher3.nano.LauncherLogProto.Action;
...
public class LoggerUtils {
    ...
    public static LauncherLogProto.LauncherEvent initLauncherEvent(
        ...
        event.srcTarget = new Target[2];
        event.srcTarget[0] = initTarget(v);
        event.srcTarget[1] = new Target();
    ...
    public static LauncherLogProto.LauncherEvent initLauncherEvent(
        ...
        event.srcTarget = new Target[1];
        event.srcTarget[0] = new Target();
