...
public class Workspace extends PagedView
    ...
    DeviceDJMainActivity.LauncherOverlay mLauncherOverlay;
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        DeviceProfile grid = mDeviceDJMainActivity.getDeviceProfile();
    ...
    public int[] estimateItemSize(ItemInfo itemInfo, boolean springLoaded) {
        float shrinkFactor = mDeviceDJMainActivity.getDeviceProfile().workspaceSpringLoadShrinkFactor;
        int[] size = new int[2];
        if (getChildCount() > 0) {
    ...
    public void onDragStart(DragObject dragObject, DragOptions options) {
        ...
        mDeviceDJMainActivity.onDragStarted();
...
//        }
    ...
    public Folder getOpenFolder() {
        DragLayer dragLayer = mDeviceDJMainActivity.getDragLayer();
    ...
    private int getEmbeddedQsbId() {
        return mDeviceDJMainActivity.getDeviceProfile().isVerticalBarLayout()
    ...
    public void bindAndInitFirstWorkspaceScreen(View qsb) {
        ...
        if (FeatureFlags.PULLDOWN_SEARCH) {
            firstPage.setOnTouchListener(new VerticalFlingDetector(mDeviceDJMainActivity) {
                ...
                public boolean onTouch(View v, MotionEvent ev) {
                    ...
                    if (super.onTouch(v, ev)) {
                        mDeviceDJMainActivity.startSearch("", false, null, false);
                        return true;
                    }
                    return false;
                }
            });
            firstPage.setOnInterceptTouchListener(new VerticalFlingDetector(mDeviceDJMainActivity) {
...
//                            ? R.layout.launcher_qsb_container : R.layout.launcher_qsb_blocker_view,
//                    firstPage, false);
//        }
//
...
//            }
    ...
    public CellLayout insertNewWorkspaceScreen(long screenId, int insertIndex) {
        ...
        // created CellLayout.
        CellLayout newScreen = (CellLayout) mDeviceDJMainActivity.getLayoutInflater().inflate(
                R.layout.launcher_workspace_screen, this, false /* attachToRoot */);
        newScreen.setOnLongClickListener(mLongClickListener);
        newScreen.setOnClickListener(mDeviceDJMainActivity);
    ...
    public void createCustomContentContainer() {
        CellLayout customScreen = (CellLayout)
                mDeviceDJMainActivity.getLayoutInflater().inflate(R.layout.launcher_workspace_screen, this, false);
    ...
    public void convertFinalScreenToEmptyScreenIfNecessary() {
        if (mDeviceDJMainActivity.isWorkspaceLoading()) {
        ...
        if (finalScreen.getShortcutsAndWidgets().getChildCount() == 0 &&
            ...
            mDeviceDJMainActivity.getModel().updateWorkspaceScreenOrder(mDeviceDJMainActivity, mScreenOrder);
        }
    }
    ...
    public long commitExtraEmptyScreen() {
        ...
        long newId = LauncherModel.generateNewScreenId();
    ...
    // At bind time, we use the rank (screenId) to compute x and y for launcher_hotseat items.
    // See implementation for parameter definition.
     ...
     *                          the x and y position in which to place launcher_hotseat items. Otherwise
    ...
    void addInScreen(View child, long container, long screenId, int x, int y, int spanX, int spanY,
        ...
        // Show folder title if not in the launcher_hotseat
        ...
        int childId = mDeviceDJMainActivity.getViewIdForItem(info);
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        mDeviceDJMainActivity.onWindowVisibilityChanged(visibility);
    }
    ...
    public void setLauncherOverlay(DeviceDJMainActivity.LauncherOverlay overlay) {
...
//    }
    ...
    public void onOverlayScrollChanged(float scroll) {
        ...
        float transX = mDeviceDJMainActivity.getDragLayer().getMeasuredWidth() * scroll;
        transX *= 1 - slip;
...
//        mQsbAlphaController.setAlphaAtIndex(alpha, QSB_ALPHA_INDEX_Y_TRANSLATION);
     ...
     * @param direction   the direction to move the workspace
     * @param translation the amount of shift.
     * @param alpha       the alpha for the launcher_hotseat page
     */
    public void setHotseatTranslationAndAlpha(Direction direction, float translation, float alpha) {
        ...
        if (direction != Direction.Y || !mDeviceDJMainActivity.getDeviceProfile().isVerticalBarLayout()) {
...
//                    }
    ...
    private void updateStateForCustomContent(int screenCenter) {
        ...
        if (mState == State.NORMAL) {
            mDeviceDJMainActivity.getDragLayer().setBackgroundAlpha(progress == 1 ? 0 : progress * 0.8f);
        }
    ...
    @Override
    public void onLauncherTransitionPrepare(DeviceDJMainActivity l, boolean animated,
    ...
    @Override
    public void onLauncherTransitionEnd(DeviceDJMainActivity l, boolean animated, boolean toWorkspace) {
...
//            dragRect = new Rect(0, child.getPaddingTop(), child.getWidth(), iconSize);
...
//            dragRect = new Rect(0, child.getPaddingTop(), child.getWidth(), previewSize);
    ...
    boolean willCreateUserFolder(ItemInfo info, View dropOverView, boolean considerTimeout) {
        ...
        boolean willBecomeShortcut =
                (info.itemType == LauncherSettings.ITEM_TYPE_SHORTCUT );
       //设备是否是同一个设备ID
        boolean isContainLightId=true;
        if(aboveShortcut&&!TextUtils.isEmpty(info.LightId)){
            ShortcutInfo shortcutInfoDrag= (ShortcutInfo) dropOverView.getTag();
            isContainLightId=info.LightId.equals(shortcutInfoDrag.LightId);
        }
        return true;
    }
    ...
    public boolean createUserFolderIfNecessary(View newView, long container, CellLayout target,
        ...
        if (aboveShortcut && willBecomeShortcut) {
            ...
            float scale = mDeviceDJMainActivity.getDragLayer().getDescendantRectRelativeToSelf(v, folderLocation);
            target.removeView(v);

            FolderIcon fi =
                    mDeviceDJMainActivity.addFolder(target, container, screenId, targetCell[0], targetCell[1]);
            destInfo.cellX = -1;
            destInfo.cellY = -1;
            sourceInfo.cellX = -1;
            sourceInfo.cellY = -1;
        ...
        if (d.dragSource != this) {
            ...
            if (dropTargetLayout != null && !d.cancelled) {
                ...
                if (foundCell) {
                    ...
                    //biekangdongbiekangdong
                    LauncherModel.modifyItemInDatabase(info, container, screenId, lp.cellX,
            ...
            if (d.dragView.hasDrawn()) {
                ...
                mDeviceDJMainActivity.getDragLayer().animateViewIntoPosition(d.dragView, cell, duration,
    ...
    public void getPageAreaRelativeToDragLayer(Rect outArea) {
        ...
        float scale = mDeviceDJMainActivity.getDragLayer().getDescendantCoordRelativeToSelf(this, mTempXY);
    ...
    public void onDragEnter(DragObject d) {
        ...
        if (!workspaceInModalState() && FeatureFlags.LAUNCHER3_LEGACY_WORKSPACE_DND) {
            mDeviceDJMainActivity.getDragLayer().showPageHints();
        }
    }
    ...
    public void onDragExit(DragObject d) {
        ...
        mDeviceDJMainActivity.getDragLayer().hidePageHints();
    }
    ...
    void setCurrentDragOverlappingLayout(CellLayout layout) {
        ...
        mDeviceDJMainActivity.getDragLayer().invalidateScrim();
    }
    ...
    public void getHitRectRelativeToDragLayer(Rect outRect) {
        ...
        mDeviceDJMainActivity.getDragLayer().getDescendantRectRelativeToSelf(this, outRect);
    }
    ...
    private void onDropExternal(final int[] touchXY, final ItemInfo dragInfo,
        ...
        final long container = LauncherSettings.CONTAINER_DESKTOP;
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            if (pendingInfo.itemType == LauncherSettings.ITEM_TYPE_SHORTCUT) {
            ...
            switch (info.itemType) {
                case LauncherSettings.ITEM_TYPE_SHORTCUT:
                    ...
                    view = mDeviceDJMainActivity.createShortcut(cellLayout, (ShortcutInfo) info);
                    break;
                case LauncherSettings.ITEM_TYPE_FOLDER:
                    view = FolderIcon.fromXml(R.layout.launcher_folder_icon, mDeviceDJMainActivity, cellLayout,
                            (FolderInfo) info);
                    break;
                default:
            ...
            LauncherModel.addOrMoveItemInDatabase(mDeviceDJMainActivity, info, container, screenId,
            ...
            if (d.dragView != null) {
                ...
                mDeviceDJMainActivity.getDragLayer().animateViewIntoPosition(d.dragView, view,
    ...
    public void setup(DragController dragController) {
        mSpringLoadedDragController = new SpringLoadedDragController(mDeviceDJMainActivity);
    ...
    public void onDropCompleted(final View target, final DragObject d,
       ...
       if (mDragInfo != null) {
            final CellLayout cellLayout = mDeviceDJMainActivity.getCellLayout(
    ...
    public boolean onEnterScrollArea(int x, int y, int direction) {
        ...
        boolean isPortrait = !mDeviceDJMainActivity.getDeviceProfile().isLandscape;
     ...
     * the launcher_hotseat and workspace pages
     */
     ...
     */
    public void removeItemsByMatcher(final long id) {
...
//                    Drawable oldIcon = getTextViewIcon(shortcut.getTextView());
//                    boolean oldPromiseState = (oldIcon instanceof PreloadIconDrawable)
//                            && ((PreloadIconDrawable) oldIcon).hasNotCompleted();
                    shortcut.applyFromShortcutInfo(si,
                            true);
                }
